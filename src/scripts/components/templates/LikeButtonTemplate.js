const likeButtonEl = () => `
    <button aria-label="sukai restoran ini" id="likeButton" class="like" title="Tambahkan ke favorit">
...
`
const likedButtonEl = () => `
    <button aria-label="batal sukai restoran ini" id="likeButton" class="like" title="Hapus dari favorit">
